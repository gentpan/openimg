...
var en = map[string]string{
	...
	"ai.purpose_unknown":          "Unsupported generation purpose",
	"ai.resolution_unknown":       "Unsupported resolution tier",
	"ai.resolution_denied":        "4K needs a linked pic.bi account",
	"ai.resolution_needs_session": "This tier needs a web session — API tokens are limited to the free allowance",
	"ai.picbi_unreachable":        "Can't reach pic.bi right now — please try again shortly",
	"ai.picbi_denied":             "pic.bi refused the charge — check the authorisation and account status there",
